    ...
    return (
        <div className="screenshot-container-wrap">
            <div className="balance-wrap">
                ...
                <div>
                    <img src={window.balance} alt="balance" />
                </div>
            </div>
            <div className="organize-wrap">
                ...
                <div>
                    <img src={window.expenses} alt="balance" />
                </div>
            </div>
            <div className="add-expense-wrap">
                ...
                <div>
                    <img src={window.addExpenses} alt="balance" />
                </div>
            </div>
            <div className="pay-back-wrap">
                ...
                <div>
                    <img src={window.payBack} alt="balance" />
                </div>
            </div>
            <div className="extras-wrap">
                ...
                <div>
                    <img src={window.extras} alt="balance" />
                </div>
            </div>
        </div>
